...
#define experimental variables
    ...
    for rep in range(repetitions):
        ...
        for fact_rank in fact_range:
            ...
            for epoch in range(epochs):
                ...
                epoch_results = [rep+1,fact_rank,epoch+1,train_acc.item(),test_acc.item(), train_loss.item(), val_loss.item(),auc]  # .item() necessary to get pure number instead of tensor object
    ...
    df_lnet.to_csv('fnet_reuters_results3.csv')