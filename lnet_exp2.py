...
from utils import train, test, load_data, ReutersTrain, ReutersTest
...
#load data, transform to DataSet Class & create DataLoader
    print("Loading Data.......")
    data = load_data()                  # now with 12k features! opposed to 8k previously
...
#define experimental variables
    ...
    df_lnet.to_csv('lnet_reuters_exp2.csv')